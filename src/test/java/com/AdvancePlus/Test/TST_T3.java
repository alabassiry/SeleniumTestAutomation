...
public class TST_T3 {
	...
	private Object[][] dataprovider() {
		Object[][] testData = excel.getTestData("Wrong_Password");
		return testData;
	}
	...
	public void test(String Email, String Password) throws Exception {
		try {
			...
			logger.step("Try logging in using valid email and invalid password");
			...
			Assert.assertEquals(true, loginpage.wrongPasswordMessage1.isDisplayed());
		}
